...
public class GameNumberTest {
    ...
    @Test
    public void should_show_fizz_if_raw_number_divisible_3() {
        checkGameNumberOutput(3, "fizz");
    }

    @Test
    public void should_show_buzz_if_raw_number_divisible_5() {
        checkGameNumberOutput(5, "buzz");
    }

    @Test
    public void should_show_fizzbuzz_if_raw_number_divisible_3_and_5() {
